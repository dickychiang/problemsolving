...
public class ClockRepairsDriver {
...
System.out.println(Arrays.toString(in0));
   test =  new ClockRepairs();

   //tmpVal = test.getLength(in0);
   tmpVal = test.days(in0,in1);
 ...
 System.out.println("out_of: " + counter);
   ...
   counter++; 
   int[] in2 = {6, 5, 4, 3, 2, 1, 0, 0, 1, 2, 3, 4, 5, 6};
   int in3 = 3;
   int out1 = 15;
   //String in1 = "-|-|-|-";
   //int out1 = 7;
